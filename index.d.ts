...
export type ResFormatterFunction = (res: any, tok?: object) => void | object | string

export type IssueGrantCodeFunction = (client: any, redirectUri: string, user: any, res: any, issued: (err: Error | null, code?: string, resFormatter?: ResFormatterFunction) => void) => void;

export type IssueGrantTokenFunction = (client: any, user: any, ares: any, issued: (err: Error | null, code?: string, params?: any, resFormatter?: ResFormatterFunction) => void) => void;

export type IssueExchangeCodeFunction = (client: any, code: string, redirectURI: string, issued: ExchangeDoneFunction) => void;

export type ExchangeDoneFunction = (err: Error | null, accessToken?: string | boolean, refreshToken?: string, params?: any, resFormatter?: ResFormatterFunction) => void;
